...
- **🤝 Đội 2v2 (LAN)** — 2 đội × 2 người, **mỗi đội chung một bàn** (2 đồng đội thấy &
  xây trên cùng bản đồ). **Vàng & Điểm KN riêng** cho từng người, nhưng mỗi quái chết
  cộng **bằng nhau** cho cả hai; hành động (xây/nâng/bán/phép) trừ tài nguyên của người
